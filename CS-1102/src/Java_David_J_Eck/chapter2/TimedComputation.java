...
public class TimedComputation {
    public static void main(String[] args) {
        ...
        System.out.print("      sin(100)*sin(100) + cos(100)*cos(100) - 1 " +
                "is: ");
        ...
        * Output:
        ...
        Let's check this for x = 100:
            sin(100)*sin(100) + cos(100)*cos(100) - 1 is: -1.1102230246251565E-16
        (There can be round-off errors when computing with real numbers!)

        Here is a random number:  0.002016505179410766

        The value of Math.PI is 3.141592653589793

        Run time in nanoseconds was: 2055700
        (This is probably not perfectly accurate!)

        Run time in seconds was: 0.0020557
        */
